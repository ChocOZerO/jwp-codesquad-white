...
public class Result {
    ...
    public Result(int countOfLotto) {
        ...
        results.add(new MatchingResult(Match.MATCH5BONUS));
    ...
    public enum Match {
        ...
        public static Match valueOf(int countOfMatch, boolean isBonus) {
            Match match = valueOf(countOfMatch);
            if (match != Match.MATCH5) {
                return match;
            }
            return isBonus ? Match.MATCH5BONUS : match;
        }
